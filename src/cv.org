...
Talks:
- 友盟数据分析平台架构 [[file:images/um-arch.pdf][Umeng Analytical Architecture]]
...
* Experience
** Software Engineer, Amazon.com , 2020.6 - 2020.12
...
* Projects
- itachi, a simple high-performance asynchronous network programming framework in C++. [[https://github.com/dirtysalt/dirtysalt.github.io/tree/master/codes/cc/itachi][GitHub]]
...
- brainfuck-llvm-jit, a simple JIT compiler of brainfuck using LLVM. [[https://github.com/dirtysalt/brainfuck-llvm-jit][GitHub]]
...
** 工作经历
*** 软件工程师，Amazon.com, 2020.6 - 2020.12
