...
LCA可以使用 [[https://www.geeksforgeeks.org/tarjans-off-line-lowest-common-ancestors-algorithm/][Tarjan]] 的离线 [[file:codes/contest/misc/tarjan_lca.py][算法]]，也可以将这个问题转变成为RMQ. 这个过程并不复杂，但是还比较有启发性。
